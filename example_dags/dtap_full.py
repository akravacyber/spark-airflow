...
ls('') >> mkdir('dtap_test_dir') >> put('dtap_test_dir/test.txt', 'Hello from DAG') >> cat('dtap_test_dir/test.txt') >> rm('dtap_test_dir') >> put(str(datetime.now().timestamp()).replace('.', '') + '.txt', str(datetime.utcnow()))
